...
export class EventSathi1695989178882 implements MigrationInterface {
    name = 'EventSathi1695989178882'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "question" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "question_text" character varying NOT NULL, "type" "public"."question_type_enum" NOT NULL, "options" json, "questionnaire_id" uuid NOT NULL, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "response" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "questionnaire_id" uuid NOT NULL, "responses" jsonb NOT NULL, CONSTRAINT "PK_f64544baf2b4dc48ba623ce768f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "questionnaire" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "description" text, "event_id" uuid NOT NULL, CONSTRAINT "PK_e8232a11eaabac903636eb7e71e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_fa40da56981f3a6fe573e7dce19" FOREIGN KEY ("questionnaire_id") REFERENCES "questionnaire"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "response" ADD CONSTRAINT "FK_cb08b448b768de23c7b986b4029" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "response" ADD CONSTRAINT "FK_f8118f6868bb67e99197d54b4fc" FOREIGN KEY ("questionnaire_id") REFERENCES "questionnaire"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "response" DROP CONSTRAINT "FK_f8118f6868bb67e99197d54b4fc"`);
        await queryRunner.query(`ALTER TABLE "response" DROP CONSTRAINT "FK_cb08b448b768de23c7b986b4029"`);
